...
public:
    ...
    void time_evolution();
    /*RC 01.10.2024*/ void set_wnorad();
    /*RC 01.10.2024*/ void set_wrad();
    /*MZ 05.09.2024*/ void set_mu01();
    /*MZ 05.09.2024*/ void add_radiative_decay();
...
private:
    ...
    vector<int> dihedral;
    /*MZ 05.09.2024*/ string mu01_file;
    /*MZ 05.09.2024*/ vector<double> supp_MU01, MU01, sqMU01, E1mE0third;
    /*RC 01/10/2024*/ string wrad_file, wnorad_file;
    /*RC 01/10/2024*/ vector<double> supp_wrad, wrad_prov, wrad, wnorad;
    sp_mat GammaM;
    mat Phi_q, Phi_p;
    vec prob_dens;
    vec X, Y, integral_X;
